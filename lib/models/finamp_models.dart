...
class FinampSettings {
  ...
  static Future<FinampSettings> create() async {
    ...
    return FinampSettings(
      ...
      defaultDownloadLocation: downloadLocation.id,
  ...
  DownloadLocation get internalSongDir =>
      downloadLocationsMap.values.firstWhereOrNull((element) =>
          element.baseDirectory == DownloadLocationType.internalSupport) ??
      downloadLocationsMap.values.firstWhereOrNull(
          (element) => element.baseDirectory == DownloadLocationType.cache) ??
