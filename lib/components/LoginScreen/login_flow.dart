...
class JellyfinServerClientDiscovery {
  ...
  void discoverServers(
    ...
    socket = boundSocket;
    boundSocket.broadcastEnabled =
        true; // important to allow sending to broadcast address
    boundSocket.multicastHops = 5; // to account for weird network setups
    ...
    boundSocket.send(message.codeUnits, broadcastAddress, destinationPort);
