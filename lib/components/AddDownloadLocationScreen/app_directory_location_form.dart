...
class _AppDirectoryLocationFormState extends State<AppDirectoryLocationForm> {
  ...
  late Future<Directory> applicationSupportDirectoryFuture;

  @override
  void initState() {
    super.initState();
    externalStorageListFuture = getExternalStorageDirectories();
    applicationSupportDirectoryFuture = getApplicationSupportDirectory();
  }
  ...
  Widget build(BuildContext context) {
    if (!Platform.isAndroid) {
      return FutureBuilder<Directory>(
        future: applicationSupportDirectoryFuture,
        builder: (context, snapshot) {
          ...
          final applicationSupportDirectory = snapshot.data!;
          ...
          return Form(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Offline files will be saved in the app support directory.",
