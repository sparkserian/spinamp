...
class JellyfinApiHelper {
  static const _serverInfoTimeout = Duration(seconds: 5);
  ...
  Future<PublicSystemInfoResult?> loadServerPublicInfo() async {
    ...
    var response =
        await jellyfinApi.getPublicServerInfo().timeout(_serverInfoTimeout);
  ...
  Future<PublicSystemInfoResult?> loadCustomServerPublicInfo(
    ...
    final response =
        await httpClient.get(requestUrl).timeout(_serverInfoTimeout);
